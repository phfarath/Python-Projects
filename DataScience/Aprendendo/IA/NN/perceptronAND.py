...
# Dados de entrada (X1, X2) e saída esperada (AND)
X = np.array([
    [0, 0],
    [0, 1],
    [1, 0],
...
y = np.array([0, 0, 0, 1])  # Saídas esperadas para o AND

# Criar e treinar o modelo
perceptron = PerceptronAND(n_inputs=2, learning_rate=0.1, epochs=10)
